...
{	
	...
	//Encoders
	public static final int ENCODER_LEFT_ADDRESS = 0;
	public static final int ENCODER_RIGHT_ADDRESS = 0;
	...
	public static final int LEFT_SWITCHBLADE_TALON = 5;
	public static final int RIGHT_SWITCHBLADE_TALON = 6;
